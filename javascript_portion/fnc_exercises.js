...
function luckySum(a, b, c){
  ...
  count = 0 
  if (a!=13){count = count + a}else{return count}
  if (b != 13){count = count+b}else{return count}
  if (c != 13) {count = count +c
    
  }else{return count} return count
}
...
function caught_speeding(speed, is_birthday){
  var difference = speed - 60;
  if (is_birthday){difference -=5}
console.log(difference);
  if (difference >= 21){return 2}
  if (0<difference && difference<21){return 1}
